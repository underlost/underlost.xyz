          ...
          <form onSubmit={submit}>
            ...
            <div className="grid grid-cols-2 gap-8">
              <div className="col-span-2 lg:col-span-1">
                ...
                <select
                  id="budget"
                  name="budget"
                  className="bg-white border border-plum text-plum text-lg focus:ring-lime focus:border-lime block w-full p-2.5"
                >
            ...
            <div className="mb-4">
              ...
              <textarea
                id="message"
                rows="4"
                class="bg-white border border-plum text-plum text-lg focus:outline-none focus:ring-0 focus:border-lime block w-full p-2.5 placeholder:text-plum"
